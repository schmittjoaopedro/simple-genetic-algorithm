...
public class ProblemSet {
    ...
    public static final double LOC_LOW[]  = { 1.0, -1.0 }; //X and Y
    public static final double LOC_HIGH[] = { 4.0,  1.0 }; //X and Y

    public static final double VEL_LOW = -1.0;
    public static final double VEL_HIGH = 1.0;
